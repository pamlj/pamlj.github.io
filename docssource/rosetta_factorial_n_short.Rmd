...
To reproduce PAMLj / SPSS / Superpower results in WebPower or G*Power with `Cohen's option`:
...
- Always check G*Power’s **Options**: the default is *not* consistent with classical $\eta_p^2$.
