...
* __Free (model syntax)__ : Allows computation of power parameters for any recursive mediation model, specified by typing its equations in a model syntax. See `r link_pages(nickname="mediation_free")` for details.
...
`r include_pages(topic="mediation",category="details",title="Details")`
