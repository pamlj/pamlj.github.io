...
In our example, `r opt("Monte Carlo")` method yields a required N almost equal to the one estimated by the `joint significance` method. The methods usually give very similar results. As for any Monte Carlo method, results may slightly vary from run to run. This variation is decreased by increasing the number of simulations $R$.
