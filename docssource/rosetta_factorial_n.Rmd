...
* If the user intentionally adopts a dimentioless definition of \(f_v^2\), then **Approach 2** is correct, but its interpretation differs substantially from the usual ANOVA effect sizes.
