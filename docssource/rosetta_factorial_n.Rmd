...
Different software packages often return different results for repeated-measures ANOVA power analysis, even when all input parameters appear identical. In this document we inspect this issue by comparing `r modulename()`, the [R pwr package](https://cran.r-project.org/web/packages/pwr/pwr.pdf), [`G*Power`](https://www.psychologie.hhu.de/arbeitsgruppen/allgemeine-psychologie-und-arbeitspsychologie/gpower), [WebPower](https://webpower.psychstat.org/wiki/), and the `r ext_url("Superpower R package","https://aaroncaldwell.us/SuperpowerBook/")`.
...
And the repeated measure will be correlated. The correlation among repeated measures is:
$$
...
`r pic("rosetta/pics/factorial/fac_n.3.output.1.png")`
`r pic("rosetta/pics/factorial/fac_n.3.output.2.png")`

## WebPower

`r pic("rosetta/pics/factorial/fac_n.3.output.3.png")`
`r pic("rosetta/pics/factorial/fac_n.3.output.4.png")`
