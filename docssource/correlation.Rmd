...
Finally, note that `r opt("Aim: Power")` can also be used to compute what is sometimes called post-hoc power. However, the use of post-hoc power in research is controversial [@nuzzo2021post].
