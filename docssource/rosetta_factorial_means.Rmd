...
We can see that the results are pretty similar. The difference is due to the fact that `Superpower` estimates the power based on the sample estimates of the effect size, whereas `r modulename()` uses the population effect size. 
