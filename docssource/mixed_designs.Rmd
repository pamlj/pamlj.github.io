...
To indicate that a variable varies *between* clusters (i.e., across participants but not within participants), we use the syntax keyword `between: var|cluster` (can be abbreviated to `bet: var|cluster`) (see `r link_pages(nickname="mixed_syntax")`).
