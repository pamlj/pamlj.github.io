...
Some example of setting cluster variables in different design are discussed in `r link_pages(nickname="mixed_clusters")`
...
SA is not yet available for `Mixed Models` sub-module. Nonethelless, one can run different analyses with different parameters to obtain a sensitivity analysis anyway. 
